...
abstract class _$$GetAuthEventImplCopyWith<$Res> {
  factory _$$GetAuthEventImplCopyWith(
          _$GetAuthEventImpl value, $Res Function(_$GetAuthEventImpl) then) =
...
class __$$GetAuthEventImplCopyWithImpl<$Res>
  ...
  __$$GetAuthEventImplCopyWithImpl(
      _$GetAuthEventImpl _value, $Res Function(_$GetAuthEventImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetAuthEventImpl(
      phone: null == phone
          ? _value.phone
...
abstract class GetAuthEvent extends AuthEvent {
  const factory GetAuthEvent(
      ...
      required final String sms}) = _$GetAuthEventImpl;
...
abstract class ErrorAuthState extends AuthState {
  const factory ErrorAuthState(
      ...
      final String? statusCode,
      final StackTrace? stackTrace,
      final String? responseMessage}) = _$ErrorAuthStateImpl;
...
class __$$SuccessAuthStateImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$SuccessAuthStateImpl(
      null == auth
          ? _value.auth
