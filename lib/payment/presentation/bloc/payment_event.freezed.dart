...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( double amount,  String currency,  String description,  int userId,  int subscriptionTypeId,  String? customerPhone,  String? returnUrl)?  createPayment,TResult Function( String paymentId)?  checkPaymentStatus,TResult Function()?  reset,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CreatePaymentEvent() when createPayment != null:
return createPayment(_that.amount,_that.currency,_that.description,_that.userId,_that.subscriptionTypeId,_that.customerPhone,_that.returnUrl);case CheckPaymentStatusEvent() when checkPaymentStatus != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( double amount,  String currency,  String description,  int userId,  int subscriptionTypeId,  String? customerPhone,  String? returnUrl)  createPayment,required TResult Function( String paymentId)  checkPaymentStatus,required TResult Function()  reset,}) {final _that = this;
switch (_that) {
case CreatePaymentEvent():
return createPayment(_that.amount,_that.currency,_that.description,_that.userId,_that.subscriptionTypeId,_that.customerPhone,_that.returnUrl);case CheckPaymentStatusEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( double amount,  String currency,  String description,  int userId,  int subscriptionTypeId,  String? customerPhone,  String? returnUrl)?  createPayment,TResult? Function( String paymentId)?  checkPaymentStatus,TResult? Function()?  reset,}) {final _that = this;
switch (_that) {
case CreatePaymentEvent() when createPayment != null:
return createPayment(_that.amount,_that.currency,_that.description,_that.userId,_that.subscriptionTypeId,_that.customerPhone,_that.returnUrl);case CheckPaymentStatusEvent() when checkPaymentStatus != null:
return checkPaymentStatus(_that.paymentId);case ResetPaymentEvent() when reset != null:
...
class CreatePaymentEvent implements PaymentEvent {
  const CreatePaymentEvent({required this.amount, required this.currency, required this.description, required this.userId, required this.subscriptionTypeId, this.customerPhone, this.returnUrl});
...
@override
String toString() {
  return 'PaymentEvent.createPayment(amount: $amount, currency: $currency, description: $description, userId: $userId, subscriptionTypeId: $subscriptionTypeId, customerPhone: $customerPhone, returnUrl: $returnUrl)';
}
...
@useResult
$Res call({
 double amount, String currency, String description, int userId, int subscriptionTypeId, String? customerPhone, String? returnUrl
});
...
/// Create a copy of PaymentEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? amount = null,Object? currency = null,Object? description = null,Object? userId = null,Object? subscriptionTypeId = null,Object? customerPhone = freezed,Object? returnUrl = freezed,}) {
