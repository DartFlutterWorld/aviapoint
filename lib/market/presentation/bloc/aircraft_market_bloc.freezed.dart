...
return createAirCraft(_that.title,_that.description,_that.price,_that.aircraftSubcategoriesId,_that.brand,_that.location,_that.year,_that.totalFlightHours,_that.enginePower,_that.engineVolume,_that.seats,_that.condition,_that.isShareSale,_that.shareNumerator,_that.shareDenominator,_that.isLeasing,_that.leasingConditions,_that.mainImageFile,_that.additionalImageFiles);case UpdateMarketProductEvent():
return updateProduct(_that.productId,_that.title,_that.description,_that.price,_that.aircraftSubcategoriesId,_that.mainImageUrl,_that.additionalImageUrls,_that.brand,_that.location,_that.year,_that.totalFlightHours,_that.enginePower,_that.engineVolume,_that.seats,_that.condition,_that.isShareSale,_that.shareNumerator,_that.shareDenominator,_that.isLeasing,_that.leasingConditions,_that.mainImageFile,_that.additionalImageFiles);case LoadMoreAircraftMarketEvent():
...
@override
int get hashCode => Object.hashAll([runtimeType,title,description,price,aircraftSubcategoriesId,brand,location,year,totalFlightHours,enginePower,engineVolume,seats,condition,isShareSale,shareNumerator,shareDenominator,isLeasing,leasingConditions,mainImageFile,const DeepCollectionEquality().hash(_additionalImageFiles)]);
...
@useResult
$Res call({
 String title, String? description, int price, int? aircraftSubcategoriesId, String? brand, String? location, int? year, int? totalFlightHours, int? enginePower, int? engineVolume, int? seats, String? condition, bool? isShareSale, int? shareNumerator, int? shareDenominator, bool? isLeasing, String? leasingConditions, XFile? mainImageFile, List<XFile>? additionalImageFiles
});
