...
_$PreflightInspectionCheckListDtoImpl
    _$$PreflightInspectionCheckListDtoImplFromJson(Map<String, dynamic> json) =>
        _$PreflightInspectionCheckListDtoImpl(
...
Map<String, dynamic> _$$PreflightInspectionCheckListDtoImplToJson(
        _$PreflightInspectionCheckListDtoImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'preflight_inspection_category_id':
          instance.preflightInspectionCategoryId,
