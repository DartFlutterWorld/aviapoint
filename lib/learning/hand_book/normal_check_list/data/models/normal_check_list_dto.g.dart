...
_NormalCheckListDto _$NormalCheckListDtoFromJson(Map<String, dynamic> json) => _NormalCheckListDto(
...
Map<String, dynamic> _$NormalCheckListDtoToJson(_NormalCheckListDto instance) => <String, dynamic>{
  'id': instance.id,
