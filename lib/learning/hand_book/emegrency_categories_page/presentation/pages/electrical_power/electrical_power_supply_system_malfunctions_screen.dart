...
@RoutePage()
class ElectricalPowerSupplySystemMalfunctionsScreen extends StatelessWidget {
  const ElectricalPowerSupplySystemMalfunctionsScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  'high_volts_annunciator_comes_on_or_m_batt_amps_more_than_40',
              ...
              Table(
                ...
                children: [
                  ...
                  customTableRow('2', 'electrical_load', 'reduce_immediatly_as_follows'),
              ...
              Table(
                ...
                children: [
                  ...
                  customTableRow('3', 'land', 'land_as_soon_as_practical'),
                ],
              ),
              SizedBox(height: 8),
              Center(
