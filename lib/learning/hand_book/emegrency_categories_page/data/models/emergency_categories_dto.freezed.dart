...
mixin _$EmergencyCategoriesDto {
  ...
  String get subTitleEng => throw _privateConstructorUsedError;
  ...
  $EmergencyCategoriesDtoCopyWith<EmergencyCategoriesDto> get copyWith =>
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$EmergencyCategoriesDtoImpl &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.title, title) || other.title == title) &&
            (identical(other.subTitle, subTitle) ||
                other.subTitle == subTitle) &&
            (identical(other.subTitleEng, subTitleEng) ||
                other.subTitleEng == subTitleEng) &&
