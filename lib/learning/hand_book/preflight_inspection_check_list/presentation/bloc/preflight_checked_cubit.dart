...
part 'preflight_checked_cubit.freezed.dart';

class PreflightCheckedCubit extends Cubit<PreflightCheckedState> {
  PreflightCheckedCubit() : super(const PreflightCheckedState());
...
@freezed
abstract class PreflightCheckedState with _$PreflightCheckedState {
  const factory PreflightCheckedState({@Default({}) Set<CheckProgress> checkProgress}) = _PreflightCheckedState;
}
