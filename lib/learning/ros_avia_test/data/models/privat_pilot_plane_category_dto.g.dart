...
_PrivatPilotPlaneCategoryDto _$PrivatPilotPlaneCategoryDtoFromJson(
...
Map<String, dynamic> _$PrivatPilotPlaneCategoryDtoToJson(
  _PrivatPilotPlaneCategoryDto instance,
) => <String, dynamic>{
  'id': instance.id,
