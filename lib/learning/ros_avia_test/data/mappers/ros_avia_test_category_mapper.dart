...
class RosAviaTestCategoryMapper {
  static RosAviaTestCategoryEntity toEntity(
    RosAviaTestCategoryDto model,
  ) {
    return RosAviaTestCategoryEntity(
      id: model.id,
      title: model.title,
      image: model.image,
    );
  ...
  static List<RosAviaTestCategoryEntity> toEntities(
    List<RosAviaTestCategoryDto> models,
  ) {
