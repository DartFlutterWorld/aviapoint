        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              'Часть функциональности Приложения предоставляется на платной основе по модели подписки. Оплата осуществляется через платёжную систему на сайте (в приложении открывается защищённая страница оплаты).\n\n'
                  'Стоимость, срок и условия подписки (включая «РосАвиаТест — тренировочный режим») указываются в интерфейсе до момента покупки.\n\n'
                  'Правообладатель не хранит ваши платёжные реквизиты; обработка платежей выполняется платёжным провайдером в соответствии с его правилами и политикой конфиденциальности.',
            ),
            _buildSection(
            ...
            _buildSection(
              ...
              'Приложение предоставляется по принципу «как есть» (AS IS). Правообладатель не гарантирует бесперебойную и безошибочную работу Приложения, а также его полное соответствие ожиданиям пользователя.\n\n'
                  ...
                  '• невозможность использования Приложения по причинам, не зависящим от него (сбои сети, работа сторонних сервисов, ограничения доступа к интернету и т.п.);\n'
