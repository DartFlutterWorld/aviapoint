...
class ReviewCard extends StatelessWidget {
          ...
          child: Row(
            ...
            children: [
              if (reviewerName != null) ...[
                _buildAvatar(context, reviewerAvatarUrl, 40),
                SizedBox(width: 8),
              ...
              _buildAvatar(context, reviewedAvatarUrl, 40, withBorder: true),
              SizedBox(width: 8),
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [if (!isReply && reviewedName == null) SizedBox(height: 12), _buildProfileReviewerName(), if (!isReply && reviewedName == null) _buildFlightInfo()],
              ),
            ),
          ],
        ),
  ...
  Widget _buildFlightInfo() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(height: 8), if (hasFlightInfo) _buildRoute(), _buildDepartureDate()]);
  }
        ...
        children: [
          ...sortedWaypoints.asMap().entries.expand((entry) {
            ...
            return [
              ...
              if (!isLast) ...[SizedBox(width: 4), Icon(Icons.arrow_forward, size: 14, color: Color(0xFF0A6EFA)), SizedBox(width: 4)],
            ];
          }).toList(),
        ],
      );
          ...
          if (departureDate != null)
            Row(
              ...
              children: [
                ...
                SizedBox(width: 4),
                Text(formatDate(departureDate!), style: AppStyles.regular12s.copyWith(color: Color(0xFF9CA5AF))),
              ],
            ),
  ...
  Widget _buildFlightChip() {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Color(0xFF0A6EFA).withOpacity(0.1), borderRadius: BorderRadius.circular(8)),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
  ...
  Widget _buildReviewerInfo(String name, double? rating) {
    return Column(
      ...
      children: [
        ...
        if (rating != null && rating > 0) ...[SizedBox(height: 4), RatingWidget(rating: rating.round(), size: 12)],
      ],
    );
  }
