                ...
                Row(
                  ...
                  children: [
                    ...
                    if (question.createdAt != null)
                      Text(
                        formatDateWithTime(question.createdAt!),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (canDelete && onDelete != null) ...[
                          if (canEdit && onEdit != null) SizedBox(width: 4),
                          IconButton(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (pilotRating != null && pilotRating! > 0) ...[SizedBox(height: 4), RatingWidget(rating: pilotRating!.round(), size: 12)],
                                ],
                              ),
                            ),
