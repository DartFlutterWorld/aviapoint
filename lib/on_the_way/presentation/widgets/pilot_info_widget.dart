    ...
    return Container(
      ...
      child: Row(
        children: [
          // Аватар
          GestureDetector(
            onTap: avatarUrl != null && avatarUrl!.isNotEmpty ? () => _showPhotoViewer(context, getImageUrl(avatarUrl!)) : null,
            child: ClipOval(
            ...
            child: Column(
              ...
              children: [
                ...
                if (displayReviewsCount > 0)
                  Text('$displayReviewsCount ${_getReviewsText(displayReviewsCount)}', style: AppStyles.regular12s.copyWith(color: Color(0xFF9CA5AF)))
