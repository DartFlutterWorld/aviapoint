...
_FlightQuestionDto _$FlightQuestionDtoFromJson(Map<String, dynamic> json) => _FlightQuestionDto(
...
Map<String, dynamic> _$FlightQuestionDtoToJson(_FlightQuestionDto instance) => <String, dynamic>{
  'id': instance.id,
