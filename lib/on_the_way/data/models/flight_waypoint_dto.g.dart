...
_FlightWaypointDto _$FlightWaypointDtoFromJson(Map<String, dynamic> json) => _FlightWaypointDto(
...
Map<String, dynamic> _$FlightWaypointDtoToJson(_FlightWaypointDto instance) => <String, dynamic>{
  'id': instance.id,
