...
_AirportReviewDto _$AirportReviewDtoFromJson(Map<String, dynamic> json) => _AirportReviewDto(
...
Map<String, dynamic> _$AirportReviewDtoToJson(_AirportReviewDto instance) => <String, dynamic>{
  'id': instance.id,
