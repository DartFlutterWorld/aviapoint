...
_CreateAirportReviewRequestDto _$CreateAirportReviewRequestDtoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CreateAirportReviewRequestDtoToJson(_CreateAirportReviewRequestDto instance) =>
    <String, dynamic>{
