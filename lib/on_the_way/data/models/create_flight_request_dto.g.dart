...
_CreateFlightRequestDto _$CreateFlightRequestDtoFromJson(Map<String, dynamic> json) => _CreateFlightRequestDto(
  ...
  waypoints: (json['waypoints'] as List<dynamic>?)?.map((e) => e as Map<String, dynamic>).toList(),
);

Map<String, dynamic> _$CreateFlightRequestDtoToJson(_CreateFlightRequestDto instance) => <String, dynamic>{
