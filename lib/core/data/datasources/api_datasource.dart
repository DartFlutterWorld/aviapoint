...
abstract class ApiDatasource {
  ...
  /// [queryParameters] - additional query parameters to request
  Future<T?> post<T>(String uri, {dynamic data, Map<String, dynamic>? queryParameters, Options options, Function(int, int)? onSendProgress});

  /// PUT request to API
  /// [uri] - additional url string to [baseUrl]
  /// [data] - data for put body
  /// [queryParameters] - additional query parameters to request
  Future<T?> patch<T>(String uri, {dynamic data, Map<String, dynamic>? queryParameters});

  Future<T?> delete<T>(String uri, {dynamic data, Map<String, dynamic>? queryParameters});
  Future<T?> put<T>(String uri, {dynamic data, Map<String, dynamic>? queryParameters});
}
