...
class SaleRequestNavigationRoute extends PageRouteInfo<void> {
  const SaleRequestNavigationRoute({List<PageRouteInfo>? children})
      : super(
          SaleRequestNavigationRoute.name,
          initialChildren: children,
        );
